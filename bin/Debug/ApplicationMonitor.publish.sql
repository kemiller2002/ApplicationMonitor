...
GO
PRINT N'Creating [dbo].[SystemLogging]...';
...
GO
PRINT N'Creating unnamed constraint on [dbo].[SystemLogging]...';


GO
ALTER TABLE [dbo].[SystemLogging]
    ADD DEFAULT (getutcdate()) FOR [Date];


GO
PRINT N'Creating [dbo].[SystemLoggingSelect]...';
